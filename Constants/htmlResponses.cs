...
namespace EntraGraphAPI.Constants
{
    ...
    {
        public static String denyResponse = "<html><body><h1>Access Denied</h1><p>You do not have the required permissions to access this resource.</p></body></html>";
        public static String getSuccessResponse(evaluateNGACResult getAccess,List<String>? getRedirect)
        {
            String htmlResponse = $@"
            <html>
            <head>
